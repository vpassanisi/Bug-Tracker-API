...
<li>
  <div
    ...
    {#if bug.status === 'Open'}
      <div class="col s2 center" style="padding: 0 2rem;">
    ...
    {#if bug.severity === 'Minor'}
      <div class="col s1 center" style="padding: 0 0.75rem;">
        <div class="purple" style="color: white; border-radius: 5px">
          {bug.severity}
        </div>
      </div>
    {:else if bug.severity === 'Major'}
      <div class="col s1 center" style="padding: 0 0.75rem;">
        <div class="purple darken-3" style="color: white; border-radius: 5px">
          {bug.severity}
        </div>
      </div>
    {/if}
    {#if bug.reproduceability === 'Always'}
      <div class="col s2 center" style="padding: 0 2rem;">
        <div class="cyan darken-3" style="color: white; border-radius: 5px">
          {bug.reproduceability}
        </div>
      </div>
    {:else if bug.reproduceability === 'Intermitent'}
      <div class="col s2 center" style="padding: 0 2rem;">
        <div class="cyan" style="color: white; border-radius: 5px">
          {bug.reproduceability}
        </div>
      </div>
    {/if}
